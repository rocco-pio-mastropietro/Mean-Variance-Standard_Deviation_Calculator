...
def calculate(list):    # Definisce la funzione.
    ...
    if len(list) < 9:
        ...
        calculations = {}
        empty_list = ([], [], [], [], [], [])
        mean_list, var_list, std_list, max_list, min_list, sum_list = empty_list
        mean_axis1, var_axis1, std_axis1, max_axis1, min_axis1, sum_axis1 = empty_list
        mean_axis2, var_axis2, std_axis2, max_axis2, min_axis2, sum_axis2 = empty_list
